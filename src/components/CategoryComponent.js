...
<div className='row'>
         ...
         <div className='button' >
          <button className='btn btn-primary' onClick ={this.addCategory}>Add New Category</button>
         </div>
         </div>
         <br></br>
         <h2 className= " text-center">All Categories</h2><br></br>
...
<tr key ={user.categoryId}>
 <div> <tr>
  ...
  <tr>
    <td>Action</td>
    <td>
      <button style = {{marginLeft:"10px"}}onClick= {()=> this.updateCategory(user.categoryId)} className='btn btn-info'>Update</button>
      <button style = {{marginLeft:"10px"}} onClick= {()=> this.deleteCategory(user.categoryId)} className='btn btn-danger'>Delete</button>
